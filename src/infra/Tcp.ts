...
export class Tcp implements IService {
  private static instance: Tcp; // Посилання на єдиний екземпояр класу

  private routePrefix = "/api"; // Префікс для маршрутів API
  public server = express(); // Екземпляр Express.js // Конструктор, що реалізує шаблон Singleton для класу Tcp
